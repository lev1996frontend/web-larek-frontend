...
- `reset()` - метод очищает значения всех полей формы и сбрасывает состояние валидации и ошибок. Он проходит через элементы формы и сбрасывает их значения в начальное состояние
