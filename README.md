...
`removieFromBasket` — удаляет товар из корзины.
...
Jтвечает за отображение данных карточки товара в каталоге. Он управляет взаимодействием между элементами интерфейса и данными.
...
`Basket` отвечает за отображение корзины в модальном окне и предоставляет возможность удаления позиции товара из корзины.
